...
export function getEditorShortcuts(): EditorShortcut[] {
  ...
  return [
    ...
    { label: "Add to selection", keys: mac ? "⌘Click · tree or canvas" : "Ctrl+Click · tree or canvas" },
    { label: "Range selection", keys: "Shift+Click · tree or canvas" },
    { label: "Marquee selection", keys: "Drag empty canvas" },
